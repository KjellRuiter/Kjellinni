...
module.exports = class {
    ...
    res.render('pages/chat', {chatHistory: chatData, roomID:req.params.match, user: "Janno", partner: partnerData })
    }
    static async sendMessage(req, res) {
        updateLastSent(process.env.DB_MATCHES, req.params.match, req.body.textMessage);
        const messageData = {
    ...
    static async unMatch(req, res) {
        await deleteMatch(process.env.DB_MATCHES, req.params.room)
        .then(async value => {
